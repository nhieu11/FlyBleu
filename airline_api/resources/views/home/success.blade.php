@extends('client.layouts.web', ['title' => 'Success'])
			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						<div class="contact_title text-center">Bạn đã đặt phòng thành công</div>
						<form action="/" id="contact_form" class="contact_form text-center">
							...
							<button id="form_submit_button" class="form_submit_button button trans_200">Trang chủ</button>
						</form>
					</div>
